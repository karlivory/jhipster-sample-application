...
export const DeviceDeleteDialog = (props: IDeviceDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.device.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.device.delete.question" interpolate={{ id: deviceEntity.id }}>
