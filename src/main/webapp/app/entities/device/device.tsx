  ...
  return (
    <div>
      <h2 id="device-heading">
        <Translate contentKey="jhipsterSampleApplicationApp.device.home.title">Devices</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterSampleApplicationApp.device.home.createLabel">Create new Device</Translate>
        </Link>
      </h2>
        ...
        {deviceList && deviceList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.device.home.notFound">No Devices found</Translate>
            </div>
          )
        )}
      </div>
